...
errz = (vir.z - host_mocap.pose.position.z + dis_host.z) + (nbr_mocap.pose.position.z - host_mocap.pose.position.z + dis_nbr.z);
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber host_sub2 = nh.subscribe<geometry_msgs::PoseStamped>("/vrpn_client_node/RigidBody3/pose", 10, host_pos2);

    ros::Publisher local_vel_pub = nh.advertise<geometry_msgs::TwistStamped>("drone1/mavros/setpoint_velocity/cmd_vel", 10);

    ros::Publisher local_vel_pub2 = nh.advertise<geometry_msgs::TwistStamped>("drone3/mavros/setpoint_velocity/cmd_vel", 10);
